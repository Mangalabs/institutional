...
const Projects = () => {
  ...
  const getColorScheme = useCallback((gradient) => {
    return gradient.includes("orange") ? colorSchemes.orange : colorSchemes.green;
  }, [colorSchemes]);
  ...
  const variants = {
    ...
    hoverScale: { scale: 1.05, transition: { type: "spring", stiffness: 400, damping: 10 } },
    tapScale: { scale: 0.98 },
    fadeUp: {
  ...
  return (
    <section id="projects" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        ...
        >
          <AnimatePresence>
            {filteredProjects.map(({ id, title, description, icon, tags, gradient, image, link }) => {
