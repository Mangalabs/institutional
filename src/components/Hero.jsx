        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="block md:inline-block ml-2 h-5 ">
              {text} 
              <span className="border-r-2 border-orange-light h-15 inline-block align-middle ml-1" style={{ animation: "blink 1s infinite" }}></span>
            </span>
          </motion.h1>
          ...
          >
            {heroData.buttons.map(({ text, variant, action, gradient }, i) => (
              <motion.button
                ...
                onClick={action === "scrollToProjects" ? scrollToProjects : scrollToContacts}
                ...
                style={variant === "primary" ? { background: gradient, boxShadow: "0 0 20px rgba(196, 80, 27, 0.3)" } : {}}
              >
          ...
          >
            {heroData.services.map(({ title, description, icon, iconBg, delay }, i) => (
              <motion.div
                key={i}
